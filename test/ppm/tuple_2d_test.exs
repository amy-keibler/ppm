defmodule Ppm.Tuple2DTest do
  ...
  test "set invalid element" do
    ...
    test_invalid_y = fn -> Ppm.Tuple2D.set(tuple, 0, -1, 1) end
    assert_raise(FunctionClauseError, test_invalid_y)
    test_invalid_x = fn -> Ppm.Tuple2D.set(tuple, -1, 0, 1) end
    assert_raise(FunctionClauseError, test_invalid_x)
  end
end
